...
describe('Network filters', () => {
    describe('toString', () => {
        const checkToString = (line, expected, debug = false, modifierReplacer = (modifier) => modifier) => {
...
describe('Cosmetic filters', () => {
    ...
    describe('#getScript', () => {
        ...
        it('returns undefined if script does not exist', () => {
            expect(simpleScriptlet === null || simpleScriptlet === void 0 ? void 0 : simpleScriptlet.getScript(new Map())).to.be.undefined;
        });
        it('returns a script if one exists', () => {
            expect(simpleScriptlet === null || simpleScriptlet === void 0 ? void 0 : simpleScriptlet.getScript(new Map([['script.js', 'test']]))).to.equal('test');
        });
        context('with arguments', () => {
            it('inject values', () => {
                expect(simpleScriptlet === null || simpleScriptlet === void 0 ? void 0 : simpleScriptlet.getScript(new Map([['script.js', '{{1}},{{2}},{{3}}']]))).to.equal('arg1,arg2,arg3');
            });
            it('escapes special characters', () => {
                for (const character of [
                    ...
                    expect(scriptlet === null || scriptlet === void 0 ? void 0 : scriptlet.getScript(new Map([['script.js', '{{1}}']]))).to.equal(`\\${character}`);
                }
            });
            it('handles complex cases', () => {
                for (const example of [
                    ...
                    expect(scriptlet === null || scriptlet === void 0 ? void 0 : scriptlet.getScript(new Map([['script.js', '{{1}}']]))).to.equal(example[1]);
                }
            });
        });
    });
...
describe('Filters list', () => {
    ...
    describe('multi-line filters', () => {
        const lines = (content) => parseFilters(content, { debug: true }).networkFilters.map((f) => f.toString());
...
describe('scriptlets arguments parsing', () => {
    it('parses empty argument list', () => {
        ...
        expect(filter === null || filter === void 0 ? void 0 : filter.isScriptInject()).to.be.true;
        expect(filter === null || filter === void 0 ? void 0 : filter.parseScript()).to.be.undefined;
    });
    it('parses name without args', () => {
        var _a;
        expect((_a = CosmeticFilter.parse('foo.com##+js(script-name)')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
            name: 'script-name',
            args: [],
        });
    });
    it('parses name with simple args', () => {
        ...
        for (const [scriptlet, expected] of [
            ...
            expect((_a = CosmeticFilter.parse(`foo.com##+js(${scriptlet})`)) === null || _a === void 0 ? void 0 : _a.parseScript(), scriptlet).to.eql(expected);
        }
    });
    it('parses name with empty args', () => {
        var _a;
        expect((_a = CosmeticFilter.parse('foo.com##+js(script-name,, , foo,   ,     bar)')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
            name: 'script-name',
            args: ['', '', 'foo', '', 'bar'],
        });
    });
    it('removes wrapping quotes', () => {
        var _a, _b;
        expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, "a")')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
            name: 'script-name',
            args: ['a'],
        });
        expect((_b = CosmeticFilter.parse("foo.com##+js(script-name, 'a')")) === null || _b === void 0 ? void 0 : _b.parseScript()).to.eql({
            name: 'script-name',
            args: ['a'],
        });
    });
    ...
    describe('handles objects arguments', () => {
        ...
        it('single key', () => {
            var _a;
            expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, {foo: 42})')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
                name: 'script-name',
                args: ['{foo: 42}'],
            });
        });
        it('multiple keys', () => {
            var _a, _b;
            expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, {foo: 1, bar: 2})')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
                name: 'script-name',
                args: ['{foo: 1, bar: 2}'],
            });
            expect((_b = CosmeticFilter.parse('foo.com##+js(aeld, { "type": "click", "pattern": "popMagic", "runAt": "idle" })')) === null || _b === void 0 ? void 0 : _b.parseScript()).to.eql({
                name: 'aeld',
        ...
        it('nested', () => {
            var _a;
            expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, {foo: 1, bar: 2, baz: {a: 1, b: 2}}, arg2,)')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
                name: 'script-name',
        ...
        it('escaping', () => {
            var _a;
            expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, \\{foo: 1, bar: 2\\}, {baz: {a: 1, b: 2}})')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
                name: 'script-name',
    ...
    describe('handles regexp arguments', () => {
        ...
        it('simple', () => {
            var _a;
            expect((_a = CosmeticFilter.parse('foo.com##+js(script-name, /foo/)')) === null || _a === void 0 ? void 0 : _a.parseScript()).to.eql({
                name: 'script-name',
                args: ['/foo/'],
            });
        });
